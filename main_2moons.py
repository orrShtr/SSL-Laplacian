...
from utils_datasets import generate_2moons, generate_3moons, generate_2moons_controlNoise
...
plotFlag = False
model_path = r"./results/2moons_1812"
...
# noise_param_array = np.array([0.05, 0.75, 0.1, 0.125, 0.15])
...
for i in range(noise_param_array_len):
    ...
    X, y = generate_2moons_controlNoise(n_samples=n_samples, noise_param=noise_param, toPlot=plotFlag)
    X = torch.tensor(X)
    y = torch.tensor(y)
    X0 = X[:, 0]
...
# # mu1 = 1.0
# mu1 = 2.0
# mu2_array = [0, 0.5, 1.0, 2.0, 5.0, 10.0, 15.0, 20.0, 30.0, 50.0, 70.0, 100.0]
# noise_param = 0.1
#
# mu2_array_len = len(mu2_array)
#
# drawNum = 100
#
# nmi_ssl_mean_array = []
...
#
# fig, ax = plt.subplots(1, 1, figsize=(8, 6))
# ax.plot(mu2_array, nmi_ssl_mean_array, label="$L_{SSL}$")
# ax.fill_between(mu2_array, nmi_ssl_mean_array - nmi_ssl_std_array, torch.minimum(nmi_ssl_mean_array + nmi_ssl_std_array,
#                                                                                          torch.tensor(1.0)), color='blue', alpha=0.3)
...
# plt.yticks(fontsize=16)
# plt.xticks(fontsize=16)
# savefig_path = model_path + "/images/nmi_vs_alpha_L.png"
# plt.savefig(savefig_path)
# plt.show()
#
# fig, ax = plt.subplots(1, 1, figsize=(8, 6))
# ax.plot(mu2_array, acc_ssl_mean_array, label="$L_{SSL}$")
# ax.fill_between(mu2_array, acc_ssl_mean_array - acc_ssl_std_array, torch.minimum(acc_ssl_mean_array + acc_ssl_std_array,
#                                                                                           torch.tensor(1.0)), alpha=0.3)
# ax.set_xlabel(r"$\alpha$", fontsize=22)
# ax.set_ylabel("ACC", fontsize=22)
# ax.grid(True)
# # plt.legend(loc='best', fontsize=20)
# plt.yticks(fontsize=16)
# plt.xticks(fontsize=16)
# savefig_path = model_path + "/images/acc_vs_alpha_L.png"
# plt.savefig(savefig_path)
# plt.show()
#
#
#
# fig, ax = plt.subplots(1, 1, figsize=(8, 6))
# ax.plot(mu2_array, nmi_GL_ssl_mean_array, label="$L_{SSL}$")
# ax.fill_between(mu2_array, nmi_GL_ssl_mean_array - nmi_GL_ssl_std_array, torch.minimum(nmi_GL_ssl_mean_array + nmi_GL_ssl_std_array,
#                                                                                           torch.tensor(1.0)), color='blue', alpha=0.3)
# ax.set_xlabel(r"$\alpha$", fontsize=22)
# ax.set_ylabel("NMI", fontsize=22)
# ax.grid(True)
...
# plt.yticks(fontsize=16)
# plt.xticks(fontsize=16)
# savefig_path = model_path + "/images/nmi_vs_alpha_GL.png"
# plt.savefig(savefig_path)
# plt.show()
#
# fig, ax = plt.subplots(1, 1, figsize=(8, 6))
# ax.plot(mu2_array, acc_GL_ssl_mean_array, label="$L_{SSL}$")
# ax.fill_between(mu2_array, acc_GL_ssl_mean_array - acc_GL_ssl_std_array, acc_GL_ssl_mean_array + acc_GL_ssl_std_array, torch.minimum(acc_GL_ssl_mean_array + acc_GL_ssl_std_array,
#                                                                                          torch.tensor(1.0)), color='blue', alpha=0.3)
# ax.set_xlabel(r"$\alpha$", fontsize=22)
# ax.set_ylabel("ACC", fontsize=22)
# ax.grid(True)
...
# plt.yticks(fontsize=16)
# plt.xticks(fontsize=16)
# savefig_path = model_path + "/images/acc_vs_alpha_GL.png"
# plt.savefig(savefig_path)
# plt.show()